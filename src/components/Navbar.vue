  ...
  <nav class="bg-neutral-800 border-b border-neutral-700 p-4 relative z-50">
    <div class="container mx-auto max-w-6xl flex justify-between items-center">
      ...
      <div class="hidden md:flex items-center gap-5 sm:gap-7">
        ...
        <template v-else>
          ...
          <router-link to="/favorites" class="text-gray-300 hover:text-red-500 transition-colors p-2 flex items-center" title="Избранное">
    ...
    >
      ...
      <template v-else>
        ...
        <router-link @click="isMenuOpen = false" to="/favorites" class="block py-2 text-center text-gray-300 hover:text-red-400 font-semibold transition-colors">
          Избранное
        </router-link>
